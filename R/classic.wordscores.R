...
summary.classic.wordscores <- function(object, ...){
    ...
    dd <- data.frame(Total=apply(object$data, 2, sum),
                     Min=apply(object$data, 2, min),
                     Max=apply(object$data, 2, max),
                     Mean=apply(object$data, 2, mean),
                     Median=apply(object$data, 2, median),
                     Score=object$theta)
